(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('rxjs/webSocket'), require('rxjs'), require('rxjs/operators'), require('ngx-moment'), require('@angular/common/http'), require('ts-md5'), require('@angular/router'), require('@angular/core'), require('@angular/common')) :
    typeof define === 'function' && define.amd ? define('utilidades-core', ['exports', 'rxjs/webSocket', 'rxjs', 'rxjs/operators', 'ngx-moment', '@angular/common/http', 'ts-md5', '@angular/router', '@angular/core', '@angular/common'], factory) :
    (factory((global['utilidades-core'] = {}),global.rxjs.webSocket,global.rxjs,global.rxjs.operators,global.ngxMoment,global.ng.common.http,global.tsMd5,global.ng.router,global.ng.core,global.ng.common));
}(this, (function (exports,webSocket,rxjs,operators,ngxMoment,i1,tsMd5,router,i0,common) { 'use strict';
    ...
    var ConfiguracionService = /** @class */ (function () {
        ...
        /** @nocollapse */
        ConfiguracionService.ctorParameters = function () {
            return [
                { type: i1.HttpClient }
            ];
        };
    ...
    ***************************************************************************** */
    ...
    var NotioasService = /** @class */ (function () {
        ...
        /** @nocollapse */
        NotioasService.ctorParameters = function () {
            return [
                { type: ConfiguracionService }
            ];
        };
        /** @nocollapse */ NotioasService.ngInjectableDef = i0.defineInjectable({ factory: function NotioasService_Factory() { return new NotioasService(i0.inject(ConfiguracionService)); }, token: NotioasService, providedIn: "root" });
    ...
    var MenuAplicacionesService = /** @class */ (function () {
        ...
        /** @nocollapse */
        MenuAplicacionesService.ctorParameters = function () {
            return [
                { type: ConfiguracionService }
            ];
        };
        /** @nocollapse */ MenuAplicacionesService.ngInjectableDef = i0.defineInjectable({ factory: function MenuAplicacionesService_Factory() { return new MenuAplicacionesService(i0.inject(ConfiguracionService)); }, token: MenuAplicacionesService, providedIn: "root" });
    ...
    var UtilidadesCoreService = /** @class */ (function () {
        ...
        /** @nocollapse */
        UtilidadesCoreService.ctorParameters = function () {
            return [
                { type: ConfiguracionService },
                { type: NotioasService },
        ...
        /** @nocollapse */ UtilidadesCoreService.ngInjectableDef = i0.defineInjectable({ factory: function UtilidadesCoreService_Factory() { return new UtilidadesCoreService(i0.inject(ConfiguracionService), i0.inject(NotioasService), i0.inject(MenuAplicacionesService)); }, token: UtilidadesCoreService, providedIn: "root" });
    ...
    var NotioasComponent = /** @class */ (function () {
        function NotioasComponent(notificacionService, router$$1) {
            var _this = this;
        ...
        /** @nocollapse */
        NotioasComponent.ctorParameters = function () {
            return [
                { type: NotioasService },
                { type: router.Router }
            ];
    ...
    var MenuAplicacionesComponent = /** @class */ (function () {
        function MenuAplicacionesComponent(menuService, notioasService, router$$1) {
            this.menuService = menuService;
            this.notioasService = notioasService;
            this.router = router$$1;
        }
        ...
        /** @nocollapse */
        MenuAplicacionesComponent.ctorParameters = function () {
            return [
                { type: MenuAplicacionesService },
                { type: NotioasService },
                { type: router.Router }
